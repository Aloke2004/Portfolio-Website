...
const Navbar = () => {
    ...
    return(
        <Nav>
        <NavbarContainer>
            <NavLogo to="/">Aloke Gupta</NavLogo>
            ...
            {isOpen && (
                <MobileMenu isOpen = {isOpen}>
                    ...
                    <NavLink href="#Contact" onClick={() => setIsOpen(!isOpen)}>Contact</NavLink>
                    <GithubButton onClick={() => setIsOpen(!isOpen)} style={{backgroundColor:"black"}} href={Bio.github} target="_Blank">Github Profile</GithubButton>
                </MobileMenu>
            )}
